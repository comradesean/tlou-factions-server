...
see those rows for what changed. The `0x131 Member` row's citation was also
...
| `caller_arg_1c`, `flag_27` | - | PRODUCERS RESOLVED 2026-08-20 against `FUN_00ad5b78`'s prologue: `caller_arg_1c` is the sender's `param_5` verbatim; `flag_27` is `4` iff the sender's `param_4 != 0`, else `0`. Only `FUN_00ad5b78`'s OWN caller remains untraced - it's reached via a `bctrl` through vtable slot `+0x10`, invisible to a static branch scan. | disasm `0x00ad5bc0`-`0x00ad5cc0`; caller still open |
